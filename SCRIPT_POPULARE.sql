-- =============================================================
-- SCRIPT POPULARE DATE (EXTINS & ACTUALIZAT) - PROIECT CROSSFIT
-- =============================================================

-- 1. POPULARE ABONAMENTE (Ramane setul standard de 6 tipuri)
...
-- 2. POPULARE ANTRENORI (Extins la 20)
...
-- 3. POPULARE PRODUSE (Extins la 20)
...
-- 4. POPULARE ECHIPAMENTE (Extins la 20)
...
-- 5. POPULARE TIPURI_ANTRENAMENT (Extins)
INSERT INTO TIPURI_ANTRENAMENT (TipAntrenamentID, NumeWOD, Descriere) VALUES (1, 'Murph', '1 mile run, 100 pullups, 200 pushups, 300 squats, 1 mile run');
...
INSERT INTO TIPURI_ANTRENAMENT (TipAntrenamentID, NumeWOD, Descriere) VALUES (15, 'Tabata This', 'Tabata intervals: Row, Squat, Pull-up, Push-up, Sit-up');
INSERT INTO TIPURI_ANTRENAMENT (TipAntrenamentID, NumeWOD, Descriere) VALUES (16, 'DT', '5 rounds: 12 Deadlift, 9 Hang Power Clean, 6 Push Jerk');

-- 6. POPULARE COMPETITII (Extins)
...
-- 7. POPULARE MEMBRI (Extins la 25 cu @gmail.com)
...
-- 9. POPULARE ACHIZITII (Extins la ~20)
...
-- 12. POPULARE NECESAR_ECHIPAMENT (Extins)
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (2, 1); -- Fran needs bar
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (3, 1); -- Haltere needs bar
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (3, 2); -- Haltere needs plates
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (6, 1); -- Linda needs bar
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (6, 2);
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (7, 1); -- Grace needs bar
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (8, 1); -- Isabel needs bar
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (9, 17); -- Karen needs medball
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (10, 4); -- Annie needs rope
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (10, 19); -- Annie needs abmat
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (12, 4); -- Helen needs KB
INSERT INTO NECESAR_ECHIPAMENT (TipAntrenamentID, EchipamentID) VALUES (16, 1); -- DT needs bar

-- 13. POPULARE ORAR_TEMPLATE (Extins)
...
-- 14. POPULARE PARTICIPARI_COMPETITIE (Extins)
...
-- SINCRONIZARE SECVENTE (Actualizate valorile de start pentru a evita coliziuni)
